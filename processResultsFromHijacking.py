...
vicNeighborDict = {}
hijNeighborDict = {}
#for each result file, process down results
for file in files:
    if 'tk-route-views.nwax' not in file: #filter by nwax again
        continue
...
print('ALL DONE! view results with graphFinalClassData.py')
