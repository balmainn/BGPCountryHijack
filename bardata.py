...
# plt.legend(custom_lines, bbox_to_anchor=(1.05, 1), loc='upper left', labels=['low', 'low-med','med-high','high','weighted average'])

# plt.subplots_adjust(left=0.88,
#                     bottom=0.11, 
#                     right=0.9, 
#                     top=0.88, 
#                     wspace=0.321, 
...
# plt.savefig("avg-success-bar",dpi=1200)
    # info[parts[0]]={"average":parts[1],"success":parts[2],
    #                     "partial":parts[3],"failure":parts[4],
    #                     "linkLevel":parts[5],"neighbors":parts[6]}
