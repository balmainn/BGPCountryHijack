...
for prefix_p in prefixes:
    ...
    #currently just downloading the data, needs to be fixed later.

    if isMultihomed:
        
        #do this all over again, but not now
        print("IS MULTIHOMED")
...
asns = ['174']#,'8978', '61160', '202865','24482'] #'199524'
for asn in asns:
    avgs =0
    counter =0
    ctr3 =0
